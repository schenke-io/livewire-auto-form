<div class="bg-white rounded-md shadow p-4 space-y-6">
    <div class="flex items-center justify-between">
        <h3 class="text-lg font-semibold">Edit River{{ $this->getSaveModeSuffix() }}</h3>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <label class="block">
            <span class="text-sm text-gray-600">Length (km)</span>
            <input type="number" class="mt-1 w-full border rounded px-2 py-1" wire:model="form.length_km">
        </label>
    </div>
